...
Description
    Transient solver for magnetohydrodynamics (MHD): 
    compressible, buoyant, turbulent flow of a electrically
    ...
    and pseudo-transient simulations.
...
int main(int argc, char *argv[])
{
    argList::addNote
    (
        "Transient solver for compressible, buoyant, turbulent"
        " MHD flow of electrically conducting fluids"
